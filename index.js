...
let arrayCopy = copy(originalFlavors);
...
console.log(addFlavor(arrayCopy, "Rainbow Sherbert"));
...
console.log(removeLastFlavor(arrayCopy));
...
console.log(getFlavorByIndex(arrayCopy, 2));
...
console.log(removeFlavorByName(arrayCopy, "Rocky Road"));
...
console.log(getAverageWordLength(arrayCopy));
